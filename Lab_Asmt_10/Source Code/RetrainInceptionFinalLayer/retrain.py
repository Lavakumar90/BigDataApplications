...
#  print(type(test_ground_truth))
  tf_ground_truth=tf.constant(np.asarray(test_ground_truth))
  print(tf.argmax(tf_ground_truth,1))
#  print(predictions)

  ground_truth_array=sess.run(tf.argmax(tf_ground_truth,1))


  cm = confusion_matrix(ground_truth_array, predictions)
